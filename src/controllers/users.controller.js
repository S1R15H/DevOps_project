...
import { getAllUsers, getUserById as getUserByIdService, updateUser as updateUserService, deleteUser as deleteUserService } from "#services/users.services";
...
export const updateUser = async (req, res, next) => {
    try {
        ...
        if (updates.role && currentUser.role !== 'admin') {
            return res.status(403).json({ error: 'Forbidden: You cannot change your role.' });
        }
